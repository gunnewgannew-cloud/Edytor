...
(function() {
    ...
    // DEFINITION OF THE POWERFUL ELEVEN (Enterprise English Edition)
    var proFeatures = [
        { id: 'adkiller', name: '💥 Ad-Killer (Survival Mode)', key: 'pro_mod_adkiller', color: '#ffaa66' },
        { id: 'fps', name: '📊 FPS & Performance HUD', key: 'pro_mod_fps', color: '#66ffaa' },
        { id: 'video', name: '🎬 Video Accelerator', key: 'pro_mod_video', color: '#ffee66' },
    ...
    console.log("--- Menu.js Version 9.2 (Core Unified Edition) Loaded ---");
                ...
                fetch(url)
                    ...
                    .then(data => {
                        ...
                        if (data.AbstractText) {
                            html += `<div style="background:rgba(85,255,85,0.1);border-left:3px solid #55ff55;padding:8px;margin-bottom:8px;border-radius:4px;">
                                        <b style="color:#55ff55;">Odpowiedź:</b><br>${data.AbstractText}
                                     </div>`;
                        }
