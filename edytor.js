(function() {
    ...
    s.onload = function() {
        ...
        style.innerHTML = `
            ...
            .eruda-entry-btn { background: #61afef !important; color: #fff !important; }
        `;
        ...
        w.innerHTML = `
            <div id="edytor-header" style="padding:12px;background:#1a1a22;cursor:move;border-radius:15px 15px 0 0;display:flex;justify-content:space-between;align-items:center;touch-action:none;border-bottom: 2px solid #61afef;">
                <b style="color:#61afef;font-family:sans-serif;font-size:16px;">Edytor Pro V2</b>
                <div style="display:flex;align-items:center;">
                    <input id="eSearch" type="text" placeholder="Szukaj..." style="width:70px;background:#333;color:#fff;border:none;border-radius:20px;padding:4px 10px;margin-right:8px;font-size:12px;">
                    <button id="eMi" style="background:#333;color:#fff;border:none;border-radius:50%;width:30px;height:30px;margin-right:5px;font-size:16px;">↕</button>
                    <button id="eCa" style="background:#ef5350;color:#fff;border:none;border-radius:50%;width:30px;height:30px;margin-right:5px;font-size:16px;">X</button>
                    <button id="eSa" style="background:#61afef;color:#fff;border:none;border-radius:20px;padding:6px 18px;font-weight:bold;">Zapisz</button>
                </div>
            </div>
        ...
        eruda.get('snippets').add('Edytor', function() {
            ...
            b.style = 'position:fixed;pointer-events:none;border:3px dashed #61afef;z-index:999998;border-radius:10px;';
